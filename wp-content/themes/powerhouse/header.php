...
<html>
	<head>
		<meta charset="utf-8">
    <title>Powerhouse Brewing Company | London, Ontario</title>
		<!-- [ SEO ] -->
		<meta name="description" 						content="Located at 100 Kellogg Lane in London Ontario, our craft brewery is coming soon! We will be offering tours, tastes and memorable dining experiences!" />
		<!-- [ FACEBOOK OG ] -->
    <head prefix="og: http://ogp.me/ns# fb: http://ogp.me/ns/fb# website: http://ogp.me/ns/website#">
    <meta property="fb:app_id" content="220750285165409" />
    <meta property="og:type" content="website" />
    <meta property="og:url"  content="<?php bloginfo('url'); ?>" />
    <meta property="og:title" content="Powerhouse Brewing Company | London, Ontario" />
    <meta property="og:image" content="<?php bloginfo('template_url'); ?>/img/social/pwh-og-fb.png" />
		<!-- [ TWITTER CARDS ] -->
		<meta name="twitter:card"           content="<?php bloginfo('template_url'); ?>/img/social/pwh-social-twit.png" />
		<meta name="twitter:site"           content="@SAMPLE">
		<meta name="twitter:creator"        content="@SAMPLE">
		<meta name="twitter:title"          content="Powerhouse Brewing Company | London, Ontario" />
		<meta name="twitter:description"    content="Located at 100 Kellogg Lane in London Ontario, our craft brewery is coming soon! We will be offering tours, tastes and memorable dining experiences!" />
		<meta name="twitter:image"          content="<?php bloginfo('template_url'); ?>/img/social/pwh-social-twit.png" />
		<!-- [ FONTS ] -->
		<link href="https://fonts.googleapis.com/css?family=Anton|Merriweather+Sans:300,300i,700" rel="stylesheet">
		<!-- [ RESPONSIVE VIEWPORT ] -->
